...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addNotification("Hospital registered successfully!", "success");
      navigate("/dashboard");
    } catch (err: any) {
      const errorMessage =
      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-bold text-blue-900">ClaimEase</h1>
          </div>
            ...
            {step === 1 ? (
              <>
                ...
                <button
                  ...
                  onClick={handleNext}
                  disabled={loading}
                  className="w-full mt-6 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold rounded-lg transition duration-200 flex items-center justify-center gap-2"
                >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4 mt-6">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex-1 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold rounded-lg transition duration-200"
                    >
